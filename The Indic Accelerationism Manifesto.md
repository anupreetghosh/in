...
**Gathering of precise, reliable Statistics about contemporary India**
For an effective policy making for the sake of India's growth we would also need accurate statistics. The trend in the world is collecting high quality high volume data about the society we live. The Nation which collects more accurate data, more effective will be their policy. Also we need more relevant data. For instance the fmcg market might have reliably detect and predict the state of rural economy in India a decade ago, but right now with jio revolution we can have new avenues to measure them. Industry will also be more confident as their investment would be backed up by solid data analysis and not just hunch/blurry datasets.
To take an example how varied and advanced data analysis has become; there was much discussions in west about recent survey about widening ideological gap between gen z men and women. Though Some people disputed the methods and provided alternative ways to measure but think for instance the implications: thanks to high quality data advanced economies can now potentially detect generation specific problems in real time backed by actual data not some anecdotal evidences and reliably rememdy the problems. this is exciting as these things werent really measured before at such a large scale. So a interesting question for our case in India is how do we indigeneously measure those things? Or other new emergent phenomenons in Indian economy, reliably? Doing this will be vital as then Indian private sector would able to invest more effectively in the economy while Policy maker's decisions will be more effective. 